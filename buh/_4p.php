...
$content = str_replace('{CHECK}', '_____________________', $content);//($_SESSION['currentUser']->ik === 0 ? 'бухгалтер ТИК' : 'председатель ТИК')
